...
library(viridis)
```
I will access a dataset available in a built-in package
```{r}
dataset<-iris
...
boxplot(Petal.Length ~ Species, data = iris, main = "Iris data",
        ylab = "Length of Petals", col = "white",
...
myviolin<-ggplot(data=iris)+
  geom_violin(aes(x = Species, y = Petal.Length, color = Species, fill=Species), alpha = 0.35)+xlab("The Petal Length") + ylab("Density")
print(myviolin)
