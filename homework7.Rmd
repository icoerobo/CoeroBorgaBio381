...
What's the best fitting model? The normal and gamma ones are fitting either way, but the normal convinces me the most. 

Now Basing on my parameters (Mean=124, sd=6.19) from the normal distribution, I will generate another dataset, repeating the same steps 
